...
eligible_enemies = {"white": [basic_enemy.BasicEnemy], "blue": [basic_enemy.BasicEnemy, basic_flying.BasicFlying, bouncer.Bouncer], "red": [basic_enemy.BasicEnemy, charger.Charger]}
