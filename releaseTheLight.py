...
class Game:
    ...
    def setup(self):
        ...
        self.keysDown = {pygame.K_w: False, pygame.K_a: False, pygame.K_d: False, "mouse": False}
    ...
    def run(self):
        ...
        while running:
            ...
            self.window.blit(
                self.gameWorld.getSurface(
                    (self.window_width, self.window_height),
                    frame,
                    hitboxes=self.visibleHitboxes,
                    kindVisibility=self.kindVisibility,
